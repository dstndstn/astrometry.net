...
printf("    files conform to the specifications of the FITS Standard document\n");
printf("    (known as the NASA/Science Office of Standards and Technology 'Definition\n");
printf("    of the Current  FITS Standard', document number, NOST 100-2.0, available\n");
...
printf("     - EXTEND not present in the primary array if there are extensions\n");
printf("     - BLOCKED, if present, not among the first 36 keywords\n");
...
printf("     - Image WCS keywords (CTYPEn, CRPIXn, CRVALn, etc.) in a table\n");
...
printf("     - EXTNAME, EXTVER, or EXTLEVEL keyword in primary array\n");
