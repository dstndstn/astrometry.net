...
urlpatterns += patterns('astrometry.net.views.image',
    ...
    (r'^red_green_image_(?P<size>full|display)/(?P<job_id>' + idpattern + r')/?$', 'red_green_image'),
    (r'^extraction_image_(?P<size>full|display)/(?P<job_id>' + idpattern + r')/?$', 'extraction_image'),
