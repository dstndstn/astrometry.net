...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'UserImage', fields ['license']
        db.delete_unique('net_userimage', ['license_id'])

        # Removing unique constraint on 'Submission', fields ['license']
        db.delete_unique('net_submission', ['license_id'])

        # Adding model 'FlaggedUserImage'
        db.create_table('net_flaggeduserimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['net.UserImage'])),
            ('flag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['net.Flag'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('flagged_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('net', ['FlaggedUserImage'])

        # Adding model 'Flag'
        db.create_table('net_flag', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=56, primary_key=True)),
            ('explanation', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
        ))
        db.send_create_signal('net', ['Flag'])

        # Adding field 'Calibration.x'
        db.add_column('net_calibration', 'x', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Calibration.y'
        db.add_column('net_calibration', 'y', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Calibration.z'
        db.add_column('net_calibration', 'z', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Calibration.r'
        db.add_column('net_calibration', 'r', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Deleting field 'Submission.source_type'
        db.delete_column('net_submission', 'source_type')

        # Adding field 'Submission.deduplication_nonce'
        db.add_column('net_submission', 'deduplication_nonce', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Changing field 'Submission.license'
        db.alter_column('net_submission', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['net.License']))

        # Changing field 'Job.calibration'
        db.alter_column('net_job', 'calibration_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['net.Calibration']))

        # Adding unique constraint on 'Job', fields ['calibration']
        db.create_unique('net_job', ['calibration_id'])

        # Changing field 'UserImage.license'
        db.alter_column('net_userimage', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['net.License']))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Job', fields ['calibration']
        db.delete_unique('net_job', ['calibration_id'])

        # Deleting model 'FlaggedUserImage'
        db.delete_table('net_flaggeduserimage')

        # Deleting model 'Flag'
        db.delete_table('net_flag')

        # Deleting field 'Calibration.x'
        db.delete_column('net_calibration', 'x')

        # Deleting field 'Calibration.y'
        db.delete_column('net_calibration', 'y')

        # Deleting field 'Calibration.z'
        db.delete_column('net_calibration', 'z')

        # Deleting field 'Calibration.r'
        db.delete_column('net_calibration', 'r')

        # Adding field 'Submission.source_type'
        db.add_column('net_submission', 'source_type', self.gf('django.db.models.fields.CharField')(default='image', max_length=5), keep_default=False)

        # Deleting field 'Submission.deduplication_nonce'
        db.delete_column('net_submission', 'deduplication_nonce')

        # Changing field 'Submission.license'
        db.alter_column('net_submission', 'license_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['net.License'], unique=True))

        # Adding unique constraint on 'Submission', fields ['license']
        db.create_unique('net_submission', ['license_id'])

        # Changing field 'Job.calibration'
        db.alter_column('net_job', 'calibration_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['net.Calibration']))

        # Changing field 'UserImage.license'
        db.alter_column('net_userimage', 'license_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['net.License'], unique=True))

        # Adding unique constraint on 'UserImage', fields ['license']
        db.create_unique('net_userimage', ['license_id'])
