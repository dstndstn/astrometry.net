...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.tweak_order'
        db.add_column('net_submission', 'tweak_order', self.gf('django.db.models.fields.IntegerField')(default=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.tweak_order'
        db.delete_column('net_submission', 'tweak_order')
