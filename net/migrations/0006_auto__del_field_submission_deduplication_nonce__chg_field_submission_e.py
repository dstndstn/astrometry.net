...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.error_message'
        db.alter_column('net_submission', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Submission.error_message'
        db.alter_column('net_submission', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
