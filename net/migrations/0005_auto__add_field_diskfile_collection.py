...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DiskFile.collection'
        db.add_column('net_diskfile', 'collection', self.gf('django.db.models.fields.CharField')(default='misc', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DiskFile.collection'
        db.delete_column('net_diskfile', 'collection')
