...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EnhanceVersion'
        db.create_table('net_enhanceversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('topscale', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('net', ['EnhanceVersion'])

        # Adding model 'EnhancedImage'
        db.create_table('net_enhancedimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Adding M2M table for field cals on 'EnhancedImage'
        db.create_table('enhancedimage_calibration', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('enhancedimage', models.ForeignKey(orm['net.enhancedimage'], null=False)),
            ('calibration', models.ForeignKey(orm['net.calibration'], null=False))
        ))
        db.create_unique('enhancedimage_calibration', ['enhancedimage_id', 'calibration_id'])


    def backwards(self, orm):
        
        # Deleting model 'EnhanceVersion'
        db.delete_table('net_enhanceversion')

        # Deleting model 'EnhancedImage'
        db.delete_table('net_enhancedimage')

        # Removing M2M table for field cals on 'EnhancedImage'
        db.delete_table('enhancedimage_calibration')
    ...
    models = {
        ...
        'net.diskfile': {
            ...
            'collection': ('django.db.models.fields.CharField', [], {'default': "'misc'", 'max_length': '40'}),
        ...
        'net.enhancedimage': {
            'Meta': {'object_name': 'EnhancedImage'},
        ...
        'net.enhanceversion': {
            ...
            'topscale': ('django.db.models.fields.FloatField', [], {})
        },
        'net.flag': {
        ...
        'net.submission': {
            ...
            'comment_receiver': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['net.CommentReceiver']", 'unique': 'True'}),
            'crpix_center': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'disk_file': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'null': 'True', 'to': "orm['net.DiskFile']"}),
            'downsample_factor': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2', 'null': 'True', 'blank': 'True'}),
            'error_message': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'scale_lower': ('django.db.models.fields.FloatField', [], {'default': '0.1', 'null': 'True', 'blank': 'True'}),
            ...
            'tweak_order': ('django.db.models.fields.IntegerField', [], {'default': '2', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'use_sextractor': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'null': 'True', 'to': "orm['auth.User']"}),
            'via_api': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'net.tag': {
