...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SkyObject'
        db.create_table('net_skyobject', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024, primary_key=True)),
        ))
        db.send_create_signal('net', ['SkyObject'])

        # Adding field 'Submission.processing_retries'
        db.add_column('net_submission', 'processing_retries', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding M2M table for field sky_objects on 'UserImage'
        db.create_table('net_userimage_sky_objects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userimage', models.ForeignKey(orm['net.userimage'], null=False)),
            ('skyobject', models.ForeignKey(orm['net.skyobject'], null=False))
        ))
        db.create_unique('net_userimage_sky_objects', ['userimage_id', 'skyobject_id'])


    def backwards(self, orm):
        
        # Deleting model 'SkyObject'
        db.delete_table('net_skyobject')

        # Deleting field 'Submission.processing_retries'
        db.delete_column('net_submission', 'processing_retries')

        # Removing M2M table for field sky_objects on 'UserImage'
        db.delete_table('net_userimage_sky_objects')
