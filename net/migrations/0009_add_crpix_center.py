...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.crpix_center'
        db.add_column('net_submission', 'crpix_center', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.crpix_center'
        db.delete_column('net_submission', 'crpix_center')
