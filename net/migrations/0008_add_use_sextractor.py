...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.use_sextractor'
        db.add_column('net_submission', 'use_sextractor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.use_sextractor'
        db.delete_column('net_submission', 'use_sextractor')
