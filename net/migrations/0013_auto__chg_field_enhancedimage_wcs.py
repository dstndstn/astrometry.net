...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EnhancedImage.wcs'
        db.alter_column('net_enhancedimage', 'wcs_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['net.TanWCS'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EnhancedImage.wcs'
        raise RuntimeError("Cannot reverse this migration. 'EnhancedImage.wcs' and its values cannot be restored.")
    ...
    models = {
        ...
        'net.enhancedimage': {
            ...
            'wcs': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['net.TanWCS']", 'null': 'True'})
        },
        'net.enhanceversion': {
