...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.image_width'
        db.add_column('net_submission', 'image_width', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'Submission.image_height'
        db.add_column('net_submission', 'image_height', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'Submission.via_api'
        db.add_column('net_submission', 'via_api', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.image_width'
        db.delete_column('net_submission', 'image_width')

        # Deleting field 'Submission.image_height'
        db.delete_column('net_submission', 'image_height')

        # Deleting field 'Submission.via_api'
        db.delete_column('net_submission', 'via_api')
