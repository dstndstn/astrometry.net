...
5) Determine the required scales of index files (refer to the astrometry.net documentation for determening your scales). I am using 1.5°x1.5° FOV images, so I use scales 5, 6 and 7.
